...
assert.match(stagingDeploySource, /compose run --rm --no-deps -T database-migrations/);
assert.match(stagingDeploySource, /migration container can consume the remaining rollout commands/);
