...
| Port 3000, 5432, 6379, or 8080 is occupied | `docker ps` and local process manager | Stop the conflicting local service or change the Compose port mapping deliberately. |
