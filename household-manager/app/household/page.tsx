...
function HouseholdContent({ propriumBills }: { propriumBills: boolean }) {
  ...
  async function addBill(event: FormEvent<HTMLFormElement>) { event.preventDefault(); setBills(await createBill(billName, Number(billAmount), billDueDate)); setBillName(""); setBillAmount(""); setBillDueDate(""); }
