...
| `@radix-ui/react-dialog`        | production  | Accessible dialog primitive             | Supplies portal, focus containment, restoration, inertness, scroll locking, and dismissal behind GP-22 wrappers.               | GP-22 overlay foundation |
| `@radix-ui/react-alert-dialog`  | production  | Explicit confirmation primitive         | Supplies alert-dialog semantics and prevents unsafe outside dismissal behind GP-22 wrappers.                                   | GP-22 overlay foundation |
| `@radix-ui/react-dropdown-menu` | production  | Accessible action menu primitive        | Supplies keyboard navigation, typeahead, focus restoration, and collision-aware positioning behind GP-22 wrappers.             | GP-22 overlay foundation |
