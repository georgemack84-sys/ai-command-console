...
describe("fail-closed containment handling", () => {
  it("increases restriction under uncertainty", () => {
    ...
    const record = buildCoordinationContainmentRecord({
      ...
      freshnessEvaluation: {
        ...
        state: { ...fixture.input.freshnessEvaluation.state, replayIntegrity: "quarantined" },
      },
