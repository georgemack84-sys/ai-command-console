...
import type {
  ...
  TrustCertificationEvidencePath,
  TrustCertificationInput,
  TrustCertificationObservability,
  TrustCertificationReasonCode,
  TrustCertificationRequest,
  TrustCertificationResult,
  TrustCertificationScope,
...
const CERTIFICATION_SCOPES: readonly TrustCertificationScope[] = Object.freeze([
  "INTEGRITY",
  "STRENGTH",
  "PROPAGATION",
  "REPLAY",
...
function addReason(reasons: TrustCertificationReasonCode[], reason: TrustCertificationReasonCode): void {
...
function requestCore(request: TrustCertificationRequest): TrustCertificationRequest {
...
function orderedBundles(input: TrustCertificationInput): RecommendationPortfolioBundle[] {
...
function validateTenantId(request: TrustCertificationRequest, reasons: TrustCertificationReasonCode[]): boolean {
  const valid = request.tenantId.length > 0;
  addReason(reasons, valid ? "TENANT_ID_PRESENT" : "TENANT_ID_MISSING");
  return valid;
}

function validateScope(scope: TrustCertificationScope, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateFoundation(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateAnalysis(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateObservability(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateReplay(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateSealedArtifacts(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateTenantScope(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateOwnership(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateIntegrity(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
  const certified = input.foundation.result.trustState !== "UNTRUSTED"
...
function validateStrength(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
  const certified = input.analysis.result.trustStrengthsDetected === input.analysis.evidencePath.strengthReferences.length
    && input.analysis.evidencePath.strengthReferences.length > 0
    && input.analysis.evidencePath.strengthReferences.every((ref) => (
      ref.endsWith(":VERY_STRONG")
      || ref.endsWith(":STRONG")
...
function validatePropagation(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
  const certified = input.analysis.result.trustPropagationsDetected >= input.analysis.evidencePath.propagationReferences.length
...
function validateReplayCertification(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): { certified: boolean; degraded: boolean } {
...
function validateGovernance(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateObservabilityCertification(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): { certified: boolean; incomplete: boolean } {
  const incomplete = input.observability.result.observabilityState === "OBSERVE"
    ...
    || !input.observability.result.trustGraphVisible
    ...
    || !input.observability.result.trustReplayVisible
...
function validateLineage(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): boolean {
...
function validateBoundary(input: TrustCertificationInput, reasons: TrustCertificationReasonCode[]): BoundaryValidation {
...
export function createTrustCertificationEvidencePath(input: TrustCertificationInput): TrustCertificationEvidencePath {
  ...
  return Object.freeze({
    ...
    trustReferences: normalizeStrings([
      ...
      ...input.replay.evidencePath.trustReferences,
    ]),
...
function validateLimits(
  ...
  reasons: TrustCertificationReasonCode[],
): boolean {
...
function buildObservability(result: TrustCertificationResult): TrustCertificationObservability {
  return Object.freeze({
...
export function buildTrustCertificationRequest(request: TrustCertificationRequest): TrustCertificationRequest {
  return requestCore(request);
}

export function sealTrustCertification(input: TrustCertificationInput): SealedTrustCertificationRecord {
  const reasons: TrustCertificationReasonCode[] = [];
  ...
  const evidencePath = createTrustCertificationEvidencePath(input);
  ...
  addReason(reasons, "TRUST_CERTIFICATION_IS_NOT_CONTROL");
  ...
  const certificationHash = hashCertificationValue("trust-certification-gate", {
