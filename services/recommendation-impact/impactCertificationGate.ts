...
import type {
  ImpactCertificationEvidencePath,
  ImpactCertificationInput,
  ImpactCertificationObservability,
  ImpactCertificationReasonCode,
  ImpactCertificationRequest,
  ImpactCertificationResult,
  ImpactCertificationScope,
  ImpactCertificationValidation,
...
const CERTIFICATION_SCOPES: readonly ImpactCertificationScope[] = Object.freeze([
  "INTEGRITY",
  "PROPAGATION",
  "REPLAY",
  "GOVERNANCE",
...
function addReason(reasons: ImpactCertificationReasonCode[], reason: ImpactCertificationReasonCode): void {
...
function requestCore(request: ImpactCertificationRequest): ImpactCertificationRequest {
...
function orderedBundles(input: ImpactCertificationInput): RecommendationPortfolioBundle[] {
...
function validateTenantId(request: ImpactCertificationRequest, reasons: ImpactCertificationReasonCode[]): boolean {
  const valid = request.tenantId.length > 0;
  addReason(reasons, valid ? "TENANT_ID_PRESENT" : "TENANT_ID_MISSING");
  return valid;
}

function validateScope(scope: ImpactCertificationScope, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateFoundation(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateAnalysis(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateObservability(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateReplay(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateSealedArtifacts(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateTenantScope(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateOwnership(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateIntegrity(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
  const certified = input.foundation.result.impactState !== "INVALID"
    && input.analysis.result.analysisState !== "INVALID"
    && input.foundation.impacts.length > 0
...
function validatePropagation(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateReplayCertification(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): { certified: boolean; degraded: boolean } {
...
function validateGovernance(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateObservabilityCertification(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): { certified: boolean; incomplete: boolean } {
  const incomplete = input.observability.result.observabilityState === "OBSERVE"
    ...
    || !input.observability.result.impactGraphVisible
    ...
    || !input.observability.result.impactReplayVisible
...
function validateLineage(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
...
function validateConflictVisibility(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): boolean {
  const certified = input.analysis.result.impactConflictsDetected === input.analysis.evidencePath.conflictReferences.length
    && input.observability.result.impactAuditVisible
...
function validateBoundary(input: ImpactCertificationInput, reasons: ImpactCertificationReasonCode[]): BoundaryValidation {
...
export function createImpactCertificationEvidencePath(input: ImpactCertificationInput): ImpactCertificationEvidencePath {
...
function validateLimits(
  ...
  reasons: ImpactCertificationReasonCode[],
): boolean {
...
function buildObservability(result: ImpactCertificationResult): ImpactCertificationObservability {
  return Object.freeze({
...
export function buildImpactCertificationRequest(request: ImpactCertificationRequest): ImpactCertificationRequest {
  return requestCore(request);
}

export function sealImpactCertification(input: ImpactCertificationInput): SealedImpactCertificationRecord {
  const reasons: ImpactCertificationReasonCode[] = [];
  ...
  const evidencePath = createImpactCertificationEvidencePath(input);
  ...
  addReason(reasons, "IMPACT_CERTIFICATION_IS_NOT_CONTROL");
  ...
  const certificationHash = hashCertificationValue("impact-certification-gate", {
