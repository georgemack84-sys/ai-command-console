...
import { contractResponse, requireGovernanceIntegrityViewerUser, viewForRequest } from "../core";
export const runtime = "nodejs"; export const dynamic = "force-dynamic";
export async function GET(request: Request) {
  try {
    await requireGovernanceIntegrityViewerUser();
  ...
  } catch (error) { return apiError(error, "Unable to retrieve governance integrity metadata."); }
}
